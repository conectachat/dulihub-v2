...
const emojiI18nPtBR: UseEmojiPickerType['i18n'] = {
  categories: {
    activity: 'Atividades',
  ...
  search: 'Buscar emoji (em inglês)',
  searchNoResultsSubtitle: 'Não encontramos esse emoji',
  searchNoResultsTitle: 'Nada encontrado',
  ...
  skins: {
    ...
    '5': 'Média-escura',
    '6': 'Escura',
    choose: 'Escolha o tom de pele padrão',
  },
};
